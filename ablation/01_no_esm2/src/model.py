"""
Ablation: ESM2 input zeroed out.
Model architecture identical to the original — only the ESM2 features
...
class ResidueLLPSClassifier(nn.Module):
    ...
    esm_embeds : torch.Tensor, shape ``(B, L_max, 1280)``
        ESM2 per-residue embeddings (zeroed out in this ablation).
