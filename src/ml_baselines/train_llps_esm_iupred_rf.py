"""
Train Random Forest for LLPS prediction using ESM2 + IUPred3 features.
...
def main():
    ...
    if os.path.exists(feat_cache):
        ...
        X_train, X_val, X_test = extract_features_all_splits(
            ...
            ESM2_DIR, device, args.batch_size,
        )
    ...
    # Train
    print("\n" + "=" * 60)
    print("Random Forest (ESM2 + IUPred3 features) — LLPS")
    print("=" * 60)
    ...
    model_path = os.path.join(OUT_DIR, "llps_rf_esm_iupred.pkl")
    with open(model_path, "wb") as f:
        pickle.dump(rf, f)
    print(f"\nModel saved to {model_path}")

    pred_path = os.path.join(OUT_DIR, "llps_rf_esm_iupred_predictions.csv")
