"""
Train XGBoost classifier for LLPS prediction using handcrafted sequence features.
...
# Train
print("\n" + "=" * 60)
print("XGBoost (handcrafted features) — LLPS")
print("=" * 60)
...
model_path = os.path.join(OUT_DIR, "llps_xgb_handcrafted.pkl")
with open(model_path, "wb") as f:
    pickle.dump(xgb, f)
print(f"\nModel saved to {model_path}")

pred_path = os.path.join(OUT_DIR, "llps_xgb_handcrafted_predictions.csv")
